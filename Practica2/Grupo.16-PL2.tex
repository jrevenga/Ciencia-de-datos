...
\end{Sinput}
\begin{Soutput}
 [1] ".GlobalEnv"         "package:rpart"      "package:LearnClust"
 [4] "package:magick"     "package:arules"     "package:Matrix"    
...
The downloaded binary packages are in
	C:\Users\angy7\AppData\Local\Temp\RtmpemczRZ\downloaded_packages
\end{Soutput}
\begin{Sinput}
> library(readr)
